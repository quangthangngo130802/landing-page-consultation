                            ...
                            <div class="tab-pane fade show active">
                                <div class="row">
                                    <div class="form-group mb-3 col-lg-12">
                                        ...
                                        <input value="{{ $advise->title ?? '' }}" id="title" name="title"
                                            class="form-control" type="text" placeholder="Tiêu đề">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="name" class="form-label">Chú thích <span
                                                class="text-danger">*</span></label>
                                        <input value="{{ $advise->note ?? '' }}" id="note" name="note"
                                            class="form-control" type="text" placeholder="Chú thích">
                                    </div>

                                    <div id="highlight-container" class="sortable-container  mb-3">
                                    ...
                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="name" class="form-label">Cộng đồng <span
                                                class="text-danger">*</span></label>
                                        <input value="{{ $advise->note ?? '' }}" id="note" name="note"
                                            class="form-control" type="text" placeholder="Vd: Cộng đồng Chuyển đổi số">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="name" class="form-label">Chú thích cộng đồng <span
                                                class="text-danger">*</span></label>
                                        <input value="{{ $advise->note ?? '' }}" id="note" name="note"
                                            class="form-control" type="text" placeholder="Vd: Giao lưu & Chia Sẻ">
                                    </div>

                                    <div class="form-group mb-3 col-lg-12">
                                        <label for="name" class="form-label">Link nhóm<span
                                                class="text-danger">*</span></label>
                                        <input value="{{ $advise->link ?? '' }}" id="link" name="link"
                                            class="form-control" type="text" placeholder="Link nhóm">
                                    </div>
                                </div>
